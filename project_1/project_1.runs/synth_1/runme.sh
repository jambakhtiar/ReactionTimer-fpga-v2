...
HD_PWD='/home/jam/Documents/1.Freelancer/inProgress/ReactionTimer/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reaction_Timer_System.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reaction_Timer_System.tcl
